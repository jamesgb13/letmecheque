...
if selected_tab == "🏠 Overview":
    ...
    csv_path = os.path.join(os.path.expanduser("~"), "Desktop", "Cleaned_Monthly_Spending.csv")
...
if selected_tab == "💡 Smart Advisor":
    ...
    platform_path = os.path.join(os.path.expanduser("~"), "Desktop", "final_irish_online_shopping_50.csv")
